# Ce code a pour but de scrapper les données d'un site internet : "moka mag" afin d'identifier les 10 meilleurs festivals en France et de les mettre dans le fichier csv : "10_meilleurs_festivals.csv"
